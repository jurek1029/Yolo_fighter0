		 ...
		 if(YoloEngine.isUsingSkill) 
			{
			 ...
			 switch (YoloEngine.usedSkill)
				...
				case 0:
					...
					break;
				case 1:
					YoloGameRenderer.skillPlayerVe.add(new Skill(x_skill,y_skill,YoloEngine.SkillSprite2,10,.125f, .375f,3f,3f,1f));
					YoloEngine.mMultislayer.sendMessageToAllreliable((x_skill+"|"+y_skill+"|"+YoloEngine.SkillSprite2+"|"+0+"|"+.125f+"|"+ .375f+"|"+3f+"|"+3f).getBytes());
					break;
				case 2:
					YoloGameRenderer.skillPlayerVe.add(new Skill(x_skill,y_skill,YoloEngine.SkillSprite3,10,0,0,20f,20f,1f));		
