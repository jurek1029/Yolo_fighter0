...
public class YoloGame extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if(YoloEngine.test) {
			YoloEngine.TeamAB[0] = new YoloPlayer(3f,10f,YoloEngine.TeamAB[YoloEngine.MyID].playerTeam,0,0);
			YoloEngine.TeamAB[1] = new YoloPlayer(3f,10f,YoloEngine.TeamAB[YoloEngine.MyID].playerTeam,1,1);
			YoloEngine.TeamAB[2] = new YoloPlayer(10f,8f,!YoloEngine.TeamAB[YoloEngine.MyID].playerTeam,2,2);
			YoloEngine.TeamAB[3] = new YoloPlayer(9f,8f,!YoloEngine.TeamAB[YoloEngine.MyID].playerTeam,3,3);
		}
