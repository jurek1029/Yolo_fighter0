...
public class YoloObject {
	...
	YoloObject(float min_x,float min_y,float dMax_x,float dMax_y)
	{
		...
		*/
		this.min_x = min_x/YoloEngine.TX;
		this.max_x = (min_x+dMax_x)/YoloEngine.TX;
		this.min_y = (YoloEngine.LEVEL_Y-(min_y+dMax_y))/YoloEngine.TY;
		this.max_y = (YoloEngine.LEVEL_Y-min_y)/YoloEngine.TY;
